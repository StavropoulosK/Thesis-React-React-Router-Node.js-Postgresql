                    ...
                    return(
                        <article key={lessonIndex} className="userLessonContainer">
                            ...
                            <div className="bottom">
                                    <LessonDetails lessonInfo={lessonInfoContainer[lessonIndex]} onCancel={onCancel} textLeft={textLeft} showIndex={true}></LessonDetails>
